...
<!--// schedule -->
<link href="/resources/css/_schedule/schedule_01.css?ver=20230330103500000"	rel="stylesheet">
<script src="/resources/js/_schedule/schedule_01.js?ver=20230330103500000"></script>
            ...
            <div id="menuAll" style="display: block;">
                <ul>
                    <li>
                        <a href="#menu">업무 보고</a>
                        <ul>
                            <li ><a href="#menu">유지보수</a></li>
                            <li><a href="#menu">주간업무</a></li>
                            <li><a href="#menu">회의록</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#menu">일정 관리</a>
		...
		<section class="leftMenu">
			...
			<section class="lmTop">
				<p id="pageNavi" class="ftSize20 ftBold mgB10">
					게시판&nbsp;&nbsp;<span class="ftNormal colGray2">자료실</span>
				</p>
				<div id="leftTop">
			...
			<section class="lmMenu">
				...
				<ul id="leftMenuList">
					<li><a href="/WEB-INF/views/clipboard/clipboard_01.html">공지사항</a></li>
					<li class="lmChoice"><a href="/WEB-INF/views/clipboard/clipboard_02.html">자료실</a></li>
					<li><a href="/WEB-INF/views/clipboard/clipboard_03.html">업무공유</a></li>
				</ul>
			</section>
			<footer></footer>
