...
<link href="/resources/css/system/system_02.css?ver=20250624103500000"
	rel="stylesheet">
</head>
<body>
	<!-- top -->
				...
				<div class="autoSizeLayerT">
					<div class="autoSizeLayerCls">
						<a href="#popclose" class=""
							onclick="fnVacationClose(); return false;"><img
							src="/resources/images/btn/btn_popclose.png" alt="닫기"></a>
					</div>
					<div class="autoSizeLayerTInner">
						<h4 class="ui-draggable-handle txtC">
							<span id="vacationNm"></span>님 휴가사용 현황
						</h4>
					</div>
				</div>
	...
	<section class="schBox">
		...
		</select>&nbsp; <select style="width: 120px;" id="selStatus">
			<option value="17">가입</option>
			<option value="18">탈퇴</option>
		</select>&nbsp; <select style="width: 120px;" id="selSearch">
			<option value="1">성명</option>
			<option value="2">아이디</option>
		</select> <input type="text" style="width: 150px;" id="txtSearch">&nbsp;
	...
	<section class="contsBox">
		<section class="contsF" style="width: 100%;">
			<table class="tableList noCursor stats" id="AppList">
				...
				<thead>
					<tr>
						<th rowspan="2"><input type="checkbox" id="allChk"
							onclick="fnCheckAll('allChk', 'chkIdx');"></th>
