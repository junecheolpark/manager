	...
	<section class="leftMenu">
			...
			<div id="leftTop">
				...
				<div id="leftTopRpt02" class="leftTopConts">
					<div class="ucTable">
						...
						<a href="#inp" class="btn btn100 btnRed mgT10"
							onclick="fnattendeesDelete(2); return false;">삭제</a>
					</div>
				</div>
		...
		<section class="lmMenu">
			<h3><img src="/resources/images/sub/leftMenu_icon_01.png" alt="대메뉴">&nbsp;&nbsp;<span
					id="leftMenuTop"><!-- 대메뉴 --></span></h3>
			<ul id="leftMenuList">
				<li><a href="#link">&nbsp;</a></li>
				<!-- class="lmChoice" -->
			</ul>
		</section>
		<footer>copyright © RYSOFT. All Rights Reserved.</footer>
	</section>
	<!-- 컨텐츠 -->
